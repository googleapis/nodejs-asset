...
export class AssetServiceClient {
  ...
  batchGetAssetsHistory(
      ...
      Promise<[
        ...
        protosTypes.google.cloud.asset.v1.IBatchGetAssetsHistoryRequest|undefined, {}|undefined
      ]>;
  batchGetAssetsHistory(
      request: protosTypes.google.cloud.asset.v1.IBatchGetAssetsHistoryRequest,
      options: gax.CallOptions,
      callback: Callback<
          protosTypes.google.cloud.asset.v1.IBatchGetAssetsHistoryResponse,
          protosTypes.google.cloud.asset.v1.IBatchGetAssetsHistoryRequest|undefined,
          {}|undefined>): void;
/**
 ...
 */
  ...
  createFeed(
      ...
      Promise<[
        ...
        protosTypes.google.cloud.asset.v1.ICreateFeedRequest|undefined, {}|undefined
      ]>;
  createFeed(
      request: protosTypes.google.cloud.asset.v1.ICreateFeedRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  getFeed(
      ...
      Promise<[
        protosTypes.google.cloud.asset.v1.IFeed,
        protosTypes.google.cloud.asset.v1.IGetFeedRequest|undefined, {}|undefined
      ]>;
  getFeed(
      request: protosTypes.google.cloud.asset.v1.IGetFeedRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  listFeeds(
      ...
      Promise<[
        ...
        protosTypes.google.cloud.asset.v1.IListFeedsRequest|undefined, {}|undefined
      ]>;
  listFeeds(
      request: protosTypes.google.cloud.asset.v1.IListFeedsRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  updateFeed(
      ...
      Promise<[
        protosTypes.google.cloud.asset.v1.IFeed,
        protosTypes.google.cloud.asset.v1.IUpdateFeedRequest|undefined, {}|undefined
      ]>;
  updateFeed(
      request: protosTypes.google.cloud.asset.v1.IUpdateFeedRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  deleteFeed(
      ...
      Promise<[
        ...
        protosTypes.google.cloud.asset.v1.IDeleteFeedRequest|undefined, {}|undefined
      ]>;
  deleteFeed(
      request: protosTypes.google.cloud.asset.v1.IDeleteFeedRequest,
      options: gax.CallOptions,
 ...
 */
  ...
  exportAssets(
      ...
      options?: gax.CallOptions):
      Promise<[
        LROperation<protosTypes.google.cloud.asset.v1.IExportAssetsResponse, protosTypes.google.cloud.asset.v1.IExportAssetsRequest>,
 ...
 */
  ...
  matchFolderFromFolderFeedName(folderFeedName: string) {
    return this._pathTemplates.folderFeedPathTemplate.match(folderFeedName).folder;
  }
  ...
  matchFeedFromFolderFeedName(folderFeedName: string) {
    return this._pathTemplates.folderFeedPathTemplate.match(folderFeedName).feed;
  }
  ...
  matchOrganizationFromOrganizationFeedName(organizationFeedName: string) {
    return this._pathTemplates.organizationFeedPathTemplate.match(organizationFeedName).organization;
  }
  ...
  matchFeedFromOrganizationFeedName(organizationFeedName: string) {
    return this._pathTemplates.organizationFeedPathTemplate.match(organizationFeedName).feed;
  }
  ...
  matchProjectFromProjectFeedName(projectFeedName: string) {
    return this._pathTemplates.projectFeedPathTemplate.match(projectFeedName).project;
  }
  ...
  matchFeedFromProjectFeedName(projectFeedName: string) {
    return this._pathTemplates.projectFeedPathTemplate.match(projectFeedName).feed;
  }
