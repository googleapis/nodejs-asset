...
class AssetServiceClient {
  ...
  constructor(opts) {
    ...
    const assetServiceStub = gaxGrpc.createStub(
      opts.fallback
        ? protos.lookupService('google.cloud.asset.v1.AssetService')
        : protos.google.cloud.asset.v1.AssetService,
      opts
    );
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [BatchGetAssetsHistoryResponse]{@link google.cloud.asset.v1.BatchGetAssetsHistoryResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *
   * const parent = '';
   * client.batchGetAssetsHistory({parent: parent})
   *   .then(responses => {
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [Feed]{@link google.cloud.asset.v1.Feed}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [ListFeedsResponse]{@link google.cloud.asset.v1.ListFeedsResponse}.
   * @returns {Promise} - The promise which resolves to an array.
