...
describe('v1p2beta1.AssetServiceClient', () => {
    ...
    describe('createFeed', () => {
        it('invokes createFeed without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.asset.v1p2beta1.CreateFeedRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.asset.v1p2beta1.Feed());
    ...
    describe('listFeeds', () => {
        it('invokes listFeeds without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.asset.v1p2beta1.ListFeedsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.asset.v1p2beta1.ListFeedsResponse());
    ...
    describe('updateFeed', () => {
        it('invokes updateFeed without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.asset.v1p2beta1.UpdateFeedRequest());
            request.feed = {};
            request.feed.name = '';
    ...
    describe('deleteFeed', () => {
        it('invokes deleteFeed without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.asset.v1p2beta1.DeleteFeedRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
