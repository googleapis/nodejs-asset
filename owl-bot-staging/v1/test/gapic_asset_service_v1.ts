...
describe('v1.AssetServiceClient', () => {
    ...
    describe('analyzeIamPolicy', () => {
        it('invokes analyzeIamPolicy without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.asset.v1.AnalyzeIamPolicyResponse());
    ...
    describe('analyzeMove', () => {
        it('invokes analyzeMove without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.asset.v1.AnalyzeMoveResponse());
            client.innerApiCalls.analyzeMove = stubSimpleCall(expectedResponse);
            const [response] = await client.analyzeMove(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.analyzeMove as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('queryAssets', () => {
        it('invokes queryAssets without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.asset.v1.QueryAssetsResponse());
            client.innerApiCalls.queryAssets = stubSimpleCall(expectedResponse);
            const [response] = await client.queryAssets(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.queryAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createSavedQuery', () => {
        it('invokes createSavedQuery without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.asset.v1.CreateSavedQueryRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.asset.v1.SavedQuery());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createSavedQuery as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getSavedQuery', () => {
        it('invokes getSavedQuery without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getSavedQuery as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateSavedQuery', () => {
        it('invokes updateSavedQuery without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.asset.v1.UpdateSavedQueryRequest());
            request.savedQuery = {};
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateSavedQuery as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteSavedQuery', () => {
        it('invokes deleteSavedQuery without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.asset.v1.DeleteSavedQueryRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteSavedQuery as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('batchGetEffectiveIamPolicies', () => {
        it('invokes batchGetEffectiveIamPolicies without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.asset.v1.BatchGetEffectiveIamPoliciesResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.batchGetEffectiveIamPolicies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('analyzeIamPolicyLongrunning', () => {
        it('invokes analyzeIamPolicyLongrunning without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.analyzeIamPolicyLongrunning as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('searchAllResources', () => {
        it('invokes searchAllResources without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchAllResources as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('uses async iteration with searchAllResources with error', async () => {
            ...
            const request = generateSampleMessage(new protos.google.cloud.asset.v1.SearchAllResourcesRequest());
            request.scope = '';
            const expectedHeaderRequestParams = "scope=";const expectedError = new Error('expected');
    ...
    describe('searchAllIamPolicies', () => {
        it('invokes searchAllIamPolicies without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchAllIamPolicies as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listSavedQueries', () => {
        it('invokes listSavedQueries without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.asset.v1.ListSavedQueriesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
