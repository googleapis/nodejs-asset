        ...
        it('invokes analyzeIamPolicyLongrunning without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.analyzeIamPolicyLongrunning(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.asset.v1.IAnalyzeIamPolicyLongrunningResponse, protos.google.cloud.asset.v1.IAnalyzeIamPolicyLongrunningRequest>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.asset.v1.IAnalyzeIamPolicyLongrunningResponse, protos.google.cloud.asset.v1.IAnalyzeIamPolicyLongrunningRequest>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.analyzeIamPolicyLongrunning as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
