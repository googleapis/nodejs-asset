...
export class AssetServiceClient {
  ...
  initialize() {
    ...
    const assetServiceStubMethods =
        ['exportAssets', 'batchGetAssetsHistory', 'createFeed', 'getFeed', 'listFeeds', 'updateFeed', 'deleteFeed', 'searchAllResources', 'searchAllIamPolicies', 'analyzeIamPolicy', 'analyzeIamPolicyLongrunning'];
