...
describe('v1p2beta1.AssetServiceClient', () => {
  ...
  describe('exportAssets', () => {
    it('invokes exportAssets without error', done => {
      ...
      // Mock request
      const request: protosTypes.google.cloud.asset.v1p2beta1.IExportAssetsRequest = {};
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
      client._innerApiCalls.exportAssets = mockSimpleGrpcMethod(
        request,
        expectedResponse,
        null
      );
      client.exportAssets(request, (err: {}, response: {}) => {
        assert.ifError(err);
    ...
    it('invokes exportAssets with error', done => {
      ...
      client.exportAssets(request, (err: FakeError, response: {}) => {
  ...
  describe('batchGetAssetsHistory', () => {
    it('invokes batchGetAssetsHistory without error', done => {
      ...
      // Mock request
      const request: protosTypes.google.cloud.asset.v1p2beta1.IBatchGetAssetsHistoryRequest = {};
      // Mock response
      const expectedResponse = {};
      // Mock gRPC layer
