...
describe('v1beta1.AssetServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = assetserviceModule.v1beta1.AssetServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = assetserviceModule.v1beta1.AssetServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });
    ...
    describe('batchGetAssetsHistory', () => {
        it('invokes batchGetAssetsHistory without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.asset.v1beta1.BatchGetAssetsHistoryResponse());
        ...
        it('invokes batchGetAssetsHistory without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchGetAssetsHistory(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.asset.v1beta1.IBatchGetAssetsHistoryResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('exportAssets', () => {
        it('invokes exportAssets without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.asset.v1beta1.ExportAssetsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes exportAssets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportAssets(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.asset.v1beta1.IExportAssetsResponse, protos.google.cloud.asset.v1beta1.IExportAssetsRequest>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.asset.v1beta1.IExportAssetsResponse, protos.google.cloud.asset.v1beta1.IExportAssetsRequest>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.exportAssets as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
